...
#define LED_PIN 6 // = D1 since ESP is used for the project
...
void loop() {
  ...
  if(digitalRead(BUTTON_GPIO) && !buttonPressed){
    ...
    if(selectedMode >= 9){ //Put number of modes here
      selectedMode = 0;
    } else {
      selectedMode++;
    }
  ...
  */
  ...
  switch (selectedMode) {
    case 0: 
      ...
      break;
      case 6: 
      lightOn1(255, 0, 0); //Good source: http://planetpixelemporium.com/tutorialpages/light.html
      break;
      case 7: 
      lightOn2(0, 0, 255); //Good source: http://planetpixelemporium.com/tutorialpages/light.html
      break;
      case 8: 
      lightOn3(0, 255, 0); //Good source: http://planetpixelemporium.com/tutorialpages/light.html
      break;
...
void lightOn1(byte r, byte g, byte b){
  for (int i = 0; i < NUM_LEDS; i++){ 
      leds[i] = CRGB(r, g, b);    
  }
  FastLED.show(); 
...
void lightOn2(byte r, byte g, byte b){
  for (int i = 0; i < NUM_LEDS; i++){ 
      leds[i] = CRGB(r, g, b);    
  }
  FastLED.show(); 
...
void lightOn3(byte r, byte g, byte b){
  for (int i = 0; i < NUM_LEDS; i++){ 
      leds[i] = CRGB(r, g, b);    
  }
  FastLED.show(); 
